...
public class DescriptorsAnnotationVisitor extends AnnotationVisitor {
	...
	public DescriptorsAnnotationVisitor(CommonDataHolderOld data, boolean remap, List<String> targets) {
		...
		if (name.equals(AnnotationElement.VALUE.get())) {
			return new AnnotationVisitor(Constant.ASM_VERSION, annotationVisitor) {
				...
				public AnnotationVisitor visitAnnotation(String name, String descriptor) {
					CommonDataHolderOld data = DescriptorsAnnotationVisitor.this.data.alterAnnotationVisitor(
